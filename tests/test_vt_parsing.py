...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Mouse events
        (b"\x1b[<35;1;1m", [MouseMoved(position=Position(x=0, y=0), button=None)]),
        ...
        (b"\x1b[<35;1;2m", [MouseMoved(position=Position(x=0, y=1), button=None)]),
        (b"\x1b[<35;2;2m", [MouseMoved(position=Position(x=1, y=1), button=None)]),
        (b"\x1b[<35;95;1m", [MouseMoved(position=Position(x=94, y=0), button=None)]),
        (b"\x1b[<35;1;95m", [MouseMoved(position=Position(x=0, y=94), button=None)]),
        (b"\x1b[<35;95;95m", [MouseMoved(position=Position(x=94, y=94), button=None)]),
        (b"\x1b[<35;500;500m", [MouseMoved(position=Position(x=499, y=499), button=None)]),
        (b"\x1b[<35;1000;1000m", [MouseMoved(position=Position(x=999, y=999), button=None)]),
