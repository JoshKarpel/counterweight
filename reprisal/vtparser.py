...
class VTParser:
    ...
    def do_action(self, action: Action, char: int, handler: Callable[[VTParser, Action, int], None]) -> None:
        match action:
            case Action.IGNORE:
                pass
...
# From https://github.com/Textualize/textual/blob/c966243b059f0352e2a23b9695776838195364a3/src/textual/_ansi_sequences.py
